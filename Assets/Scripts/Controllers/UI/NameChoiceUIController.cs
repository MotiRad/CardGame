...
public class NameChoiceUIController : MonoBehaviour
{
    ...
    public Button start,player1Portrait0, player1Portrait1,player1Portrait2, player0Portrait0, player0Portrait1 ,player0Portrait2 ;
    ...
    private void SetupInteractables()
    {
        ...
        {
            int randomStartTurn = UnityEngine.Random.Range(0,1);
        ...
        player0Portrait2.onClick.AddListener(() =>
        {
            player0Portrait.sprite = player0Portrait2.image.sprite;
        ...
        player1Portrait2.onClick.AddListener(() =>
        {
            player1Portrait.sprite = player1Portrait2.image.sprite;
